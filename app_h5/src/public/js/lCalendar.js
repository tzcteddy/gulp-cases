...
window.lCalendar = (function() {
    var MobileCalendar = function() {
        this.gearDate;
        this.minY = new Date().getFullYear();
        this.minM = 1;
        //this.minD = 1,
        this.maxY = 2020;
        this.maxM = 12;
        ...
        bindEvent: function(type) {
            ...
            function popupDate(e) {
                ...
                _self.gearDate.innerHTML = '<div class="date_ctrl slideInUp">' +
                    ...
                    '<div class="date_grid">' +
                    '<div style="padding-right: 2em">月</div>' +
                    '</div>' +
                    '</div>' +
            ...
            function setDateGearTooth(val) {
                ...
                if (date_mm && date_mm.getAttribute("val")) {
                    ...
                    //当年份到达最小值
                    if (yyVal == 0) {
                        minM =new Date().getMonth();// _self.minM - 1;2018-7-6
                    }
                    //p 当前节点前后需要展示的节点个数
                    if(val==0){//2018-7-6
                        _self.minM=new Date().getMonth()+1;
                    }
                    for (var p = 0; p < maxM - minM + 1; p++) {
                        itemStr += "<div class='tooth'>" + (minM + p + 1) + "</div>";
                    }
                    $(date_mm).html(itemStr)
